	...
	<div class="panel-body">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								echo "<option value='".$row['id']."' id='changeProduct".$row['id']."'>".$row['barang']."</option>";
										 	} // /while 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT item.barang, item.harga FROM item 	
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT item.barang, item.harga FROM item WHERE item.id = {$orderId}";
			  				...
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								$selected = "";
			  								if($row['id'] == $orderItemData['id']) {
			  									$selected = "selected";
			  								} else {
			  									$selected = "";
			  								}

			  								echo "<option value='".$row['id']."' id='changeProduct".$row['id']."' ".$selected." >".$row['barang']."</option>";
										 	} // /while 
...
<script src="include/order.js"></script>
